    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item" id="addcustmr">
            <a href="#" class="nav-link">
              <i class="nav-icon fas fa-user-plus"></i>
              <p>
                Add Users
          ...
          <li class="nav-item" id="datamigtn">
            <a href="#" class="nav-link">
          ...
          <li class="nav-item" >
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="/survy_data" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Survey Details</p>
                </a>
              </li>
...
<script src="{{ url('assets/js/blade/config/home/home.js') }}"></script>
